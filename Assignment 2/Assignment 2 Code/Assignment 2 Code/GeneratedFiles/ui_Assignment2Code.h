...
public:
    ...
    void setupUi(QMainWindow *Assignment2CodeClass)
    {
        ...
        gridLayout_control->addWidget(textBrowser_output, 11, 0, 1, 3);
        ...
        gridLayout_control->addWidget(pushButton_262144, 8, 0, 1, 1);

        pushButton_test = new QPushButton(centralWidget);
        pushButton_test->setObjectName(QString::fromUtf8("pushButton_test"));

        gridLayout_control->addWidget(pushButton_test, 10, 0, 1, 3);
