...
public:
    ...
    QLabel *label_sample_rate_value;
    ...
    QLabel *label_sample_status_value;
    QLabel *label;
    QMenuBar *menuBar;
    ...
    void setupUi(QMainWindow *MediaPlayerClass)
    {
        ...
        label_sample_status = new QLabel(centralWidget);
        label_sample_status->setObjectName(QString::fromUtf8("label_sample_status"));

        gridLayout_3->addWidget(label_sample_status, 7, 0, 1, 1);
        ...
        label_sample_rate_value = new QLabel(centralWidget);
        label_sample_rate_value->setObjectName(QString::fromUtf8("label_sample_rate_value"));

        gridLayout_3->addWidget(label_sample_rate_value, 8, 1, 1, 1);
        ...
        label_sample_status_value = new QLabel(centralWidget);
        label_sample_status_value->setObjectName(QString::fromUtf8("label_sample_status_value"));

        gridLayout_3->addWidget(label_sample_status_value, 7, 1, 1, 1);

        label = new QLabel(centralWidget);
        label->setObjectName(QString::fromUtf8("label"));
        label->setAlignment(Qt::AlignCenter);

        gridLayout_3->addWidget(label, 9, 0, 1, 2);
    ...
    void retranslateUi(QMainWindow *MediaPlayerClass)
    {
        ...
        label_sample_status->setText(QApplication::translate("MediaPlayerClass", "Sample Status", nullptr));
        ...
        label_sample_rate->setText(QApplication::translate("MediaPlayerClass", "Sample Rate", nullptr));
        ...
        label_sample_rate_value->setText(QApplication::translate("MediaPlayerClass", "TextLabel", nullptr));
        ...
        label_sample_status_value->setText(QApplication::translate("MediaPlayerClass", "TextLabel", nullptr));
        label->setText(QApplication::translate("MediaPlayerClass", "Debug", nullptr));
    } // retranslateUi
